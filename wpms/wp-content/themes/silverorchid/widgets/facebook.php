...
function gazpo_facebook_widget() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'widget_facebook', 'description' => __('A widget to display your facebook community box.', 'gazpo') );

		/* Create the widget */
		$this->WP_Widget( 'gazpo_facebook_widget', __('Facebook Community', 'gazpo'), $widget_ops );
	}
...
function update( $new_instance, $old_instance ) {
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'fburl' ); ?>"><?php _e('Facebook URL:', 'gazpo') ?></label>
