...
?>
		...
		<script src="<?php bloginfo('template_directory'); ?>/js/jquery.hoverIntent.minified.js" type="text/javascript"></script>
		<script src="<?php bloginfo('template_directory'); ?>/js/js_functions.js" type="text/javascript"></script>
